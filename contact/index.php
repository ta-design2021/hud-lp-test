      ...
      <main id="main">
        <div class="hero contact-hero">
          ...
          <div class="hero-txt">
            ...
            <p class="page-sub-ttl">お問い合わせ</p>
          </div>
          <div class="lead  wrapper fadeIn">
            <p>
              ...
              <form id="form" action="index.php" method="POST" novalidate>
                <dl class="form-area">
                  ...
                  <div class="contact-form-group">
                    ...
                    <dd>
                      <input id="input-tel" class="input-text form-control form-text validate[custom[phone]]" type="tel" name="tel"  placeholder="09012345678" required="required" data-error_placement="#tel_error" value="<?php if(isset($tel)) { echo $tel; } ?>">
                    </dd>
        ...
        <div class="footer-inner wrapper">
          ...
          <div class="footer-item">
            <ul>
              <li>
                <div class="ly_inner">
                  <a href="https://hhuudd.com/">Corporate Site</a>
                </div>
              </li>
              <li>
